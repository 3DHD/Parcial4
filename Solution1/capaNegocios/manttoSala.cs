...
namespace capaNegocios
{
    public class manttoSala
    {
        ...
        public void insertarSala()
        {
            try
            {
                String insert = "insert into hospital.Sala(Sala_Cod, Hospital_Cod, Nombre, Num_Cama) values(" + salaCod + ", " + codHospital + ", '" + nombreSala + "', " + numCama + ");";
                test.Conectar();
        ...
        public void deleteSala()
        {
            try
            {
                String delete = "delete from hospital.Sala where Sala_Cod = " + salaCod + "";
                test.Conectar();
